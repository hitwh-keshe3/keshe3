<template>
  <div class="top">
    <el-row id="nav-fixed" :class="{ nav_fixed: isFixed }">
      ...
      <el-col :span="2"
        ><div class="grid-content" @click="$router.push('/index')">
          首页
        </div></el-col
      >
      <!--      左侧-->
      <template v-if="userRole === 'consumer'">
        <el-col :span="2"
          ><div class="grid-content" @click="$router.push('/service')">
            外卖服务
          </div></el-col
        >
        <el-col :span="2"
          ><div class="grid-content" @click="$router.push('/shoppingtrolley')">
            订单管理
          </div></el-col
        >
      </template>
      <template v-else-if="userRole === 'shop'">
        <el-col :span="2"
          ><div class="grid-content" @click="$router.push('/menuedit')">
            菜单管理
          </div></el-col
        >
        <el-col :span="2"
        ...
        >
        <el-col :span="2"
          ><div class="grid-content" @click="$router.push('/ordermanager')">
            订单管理
          </div></el-col
        >
      </template>
      ...
      <template v-else>
        <el-col :span="1"
          ><div class="grid-content" @click="$router.push('/login')">
            登录
          </div></el-col
        >
        <el-col :span="1"
          ><div class="grid-content" @click="$router.push('/signin/consumer')">
            注册
          </div></el-col
        >
      </template>
